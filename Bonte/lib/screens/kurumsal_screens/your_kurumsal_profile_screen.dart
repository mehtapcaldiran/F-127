...
void main() => runApp(const YourKurumsalProfile());
        ...
        child: Center(
          child: Column(
            children: [
              ...
              TabBar(
                labelColor: const Color(0xFF123B44),
                indicatorSize: TabBarIndicatorSize.tab,
                indicatorColor: const Color(0xFF1B5966),
                indicator: BoxDecoration(
                  color: const Color(0xFFB3E1EB),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(width: 1, color: const Color(0xFF123B44),)
                ),
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: const Text('Etkinlik Tanımla'),
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const CreatEvent()));
                      },
                    ),
                  ],
                );
        ...
        SizedBox(
          ...
          child: Card(
            ...
            shape: RoundedRectangleBorder(
              side: const BorderSide(width: 1, color: Color(0xFF1B5966),),
